    ...
    >
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            This Cookie Policy explains how RecipeBook ("we", "us", and "our") uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mt-4">
            Cookies set by the website owner (in this case, RecipeBook) are called "first-party cookies". Cookies set by parties other than the website owner are called "third-party cookies". Third-party cookies enable third-party features or functionality to be provided on or through the website (e.g., advertising, interactive content, and analytics). The parties that set these third-party cookies can recognize your computer both when it visits the website in question and also when it visits certain other websites.
          </p>
        </section>
        ...
        <section className="mb-8">
          ...
          <p className="mt-4">The specific types of first and third-party cookies served through our website and the purposes they perform are described below:</p>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-4">How often will we update this Cookie Policy?</h2>
          <p>
        ...
        <section className="mb-8">
          ...
          <p>
            If you have any questions about our use of cookies or other technologies, please contact us through our <Link to="/contact" className="text-primary hover:underline">Contact Us</Link> page.
          </p>
        </section>
      </div>
    </motion.div>
